      ...
      <div class="row align-items-center">
        ...
        <div class="col-xl-6 col-bg-6 col-md-6 col-sm-12 pt-5">
          ...
          <div>
            ...
            <p v-html="description_further"></p>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      description_further: info.description_further,
      name: info.name,
      linkedin: info.links.linkedin,
      github: info.links.github,
      googlescholar: info.links.googlescholar,
    ...
    open(link) {
      switch (link) {
        ...
        case "github":
          ...
          break;
        case "googlescholar":
          window.open(this.googlescholar, "_blank");
          break;
        case "resume":
