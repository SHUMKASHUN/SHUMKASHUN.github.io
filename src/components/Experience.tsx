...
const fmtDateFn = (v: string | undefined, presentLabel: string) => {
...
const Experience: React.FC<ExperienceProps> = ({ embedded = false }) => {
  ...
  return (
    <Box w="full" minH={embedded ? 'auto' : '100vh'} bg={embedded ? 'transparent' : bg} py={embedded ? 0 : 8}>
